...
INSERT INTO cursos (id, ies_id, nome, codigo_emec, modalidade, titulo_conferido,
                    grau_conferido, carga_horaria, autorizacao_json, reconhecimento_json,
                    renovacao_reconhecimento_json, ativo, updated_at)
VALUES
-- Administração: corrige o cadastro existente (datas + renovação + CH)
(1, 1, 'Administração', 20807, 'Presencial', 'Bacharel', 'Bacharelado', '3000',
 ...
 1, NOW()),
(3, 1, 'Administração Hospitalar', 18164, 'Presencial', 'Bacharel', 'Bacharelado', '3000',
 '{"tipo":"Portaria","numero":"744","data":"1999-05-06"}',
 '{"tipo":"Portaria","numero":"572","data":"2004-03-12"}',
 NULL,
 1, NOW()),
(4, 1, 'Ciências Contábeis', 20605, 'Presencial', 'Bacharel', 'Bacharelado', '3000',
 '{"tipo":"Portaria","numero":"111","data":"2012-06-26"}',
 '{"tipo":"Portaria","numero":"705","data":"2013-12-18"}',
 NULL,
 1, NOW()),
(5, 1, 'Comunicação Social (Relações Públicas)', 21307, 'Presencial', 'Bacharel', 'Bacharelado', '2700',
 '{"tipo":"Portaria","numero":"107","data":"2000-02-10"}',
 '{"tipo":"Portaria","numero":"311","data":"2006-01-30"}',
 NULL,
 1, NOW()),
(6, 1, 'Engenharia de Produção Mecânica', 19737, 'Presencial', 'Bacharel', 'Bacharelado', '3920',
 '{"tipo":"Portaria","numero":"79","data":"1999-01-14"}',
 '{"tipo":"Portaria","numero":"278","data":"2015-04-01"}',
 NULL,
 1, NOW()),
-- Eng. Telecomunicações: autorização E carga horária NÃO informadas — pendências ao usar
(7, 1, 'Engenharia de Telecomunicações', 50974, 'Presencial', 'Bacharel', 'Bacharelado', NULL,
 NULL,
 '{"tipo":"Portaria","numero":"48","data":"2010-01-13"}',
 NULL,
 1, NOW()),
(8, 1, 'Jornalismo', 20692, 'Presencial', 'Bacharel', 'Bacharelado', '3140',
 '{"tipo":"Portaria","numero":"1809","data":"1999-12-17"}',
 '{"tipo":"Portaria","numero":"584","data":"2020-12-09"}',
 NULL,
 1, NOW()),
(9, 1, 'Pedagogia', 107330, 'Presencial', 'Licenciado', 'Licenciatura', '3200',
 '{"tipo":"Portaria","numero":"1457","data":"1998-12-23"}',
 '{"tipo":"Portaria","numero":"1094","data":"2015-12-24"}',
 NULL,
 1, NOW()),
(10, 1, 'Turismo e Hotelaria', 18343, 'Presencial', 'Bacharel', 'Bacharelado', '3000',
...
ON CONFLICT (id) DO UPDATE SET
  ...
  grau_conferido = EXCLUDED.grau_conferido, carga_horaria = EXCLUDED.carga_horaria,
  autorizacao_json = EXCLUDED.autorizacao_json,
...
INSERT INTO cursos (id, ies_id, nome, codigo_emec, modalidade, titulo_conferido,
                    ...
                    renovacao_reconhecimento_json, ativo, updated_at)
VALUES
(11, 2, 'Administração', 106513, 'Presencial', 'Bacharel', 'Bacharelado', '3000',
 '{"tipo":"Portaria","numero":"211","data":"2001-02-08"}',
 '{"tipo":"Portaria","numero":"490","data":"2006-02-09"}',
 '{"tipo":"Portaria","numero":"706","data":"2016-11-10"}',
 1, NOW()),
(12, 2, 'Comunicação Social (Publicidade e Propaganda)', 46290, 'Presencial', 'Bacharel', 'Bacharelado', '2880',
...
(13, 2, 'Engenharia Civil', 1169327, 'Presencial', 'Bacharel', 'Bacharelado', '3690',
 '{"tipo":"Portaria","numero":"406","data":"2013-08-30"}',
 '{"tipo":"Portaria","numero":"406","data":"2013-08-30"}',
 NULL,
 1, NOW()),
-- PORTARIA DUPLA
(14, 2, 'Engenharia de Produção', 1177416, 'Presencial', 'Bacharel', 'Bacharelado', '3690',
 '{"tipo":"Portaria","numero":"120","data":"2013-03-15"}',
 '{"tipo":"Portaria","numero":"120","data":"2013-03-15"}',
 NULL,
 1, NOW()),
-- PORTARIA DUPLA
(15, 2, 'Engenharia Elétrica', 1169330, 'Presencial', 'Bacharel', 'Bacharelado', '3690',
 '{"tipo":"Portaria","numero":"326","data":"2013-07-24"}',
 '{"tipo":"Portaria","numero":"326","data":"2013-07-24"}',
 NULL,
 1, NOW()),
-- PORTARIA DUPLA
(16, 2, 'Fisioterapia', 1386456, 'Presencial', 'Bacharel', 'Bacharelado', '4740',
 '{"tipo":"Portaria","numero":"172","data":"2019-04-09"}',
 '{"tipo":"Portaria","numero":"172","data":"2019-04-09"}',
 NULL,
 1, NOW()),
(17, 2, 'Serviço Social', 1165489, 'Presencial', 'Bacharel', 'Bacharelado', '3690',
 '{"tipo":"Portaria","numero":"280","data":"2012-12-19"}',
 '{"tipo":"Portaria","numero":"745","data":"2017-07-14"}',
 NULL,
 1, NOW()),
(18, 2, 'Sistema de Informação', 46287, 'Presencial', 'Bacharel', 'Bacharelado', '3000',
 '{"tipo":"Portaria","numero":"348","data":"2001-02-23"}',
 '{"tipo":"Portaria","numero":"490","data":"2006-02-09"}',
 NULL,
 1, NOW()),
(19, 2, 'Turismo', 46282, 'Presencial', 'Bacharel', 'Bacharelado', '3180',
...
INSERT INTO cursos (id, ies_id, nome, codigo_emec, modalidade, titulo_conferido,
                    ...
                    renovacao_reconhecimento_json, ativo, updated_at)
VALUES
(20, 4, 'Direito', 55596, 'Presencial', 'Bacharel', 'Bacharelado', '3700',
 '{"tipo":"Portaria","numero":"2032","data":"2002-07-15"}',
 '{"tipo":"Portaria","numero":"207","data":"2020-06-25"}',
 NULL,
 1, NOW()),
-- Administração: autorização E carga horária NÃO informadas — pendências ao usar
(21, 4, 'Administração', 20632, 'Presencial', 'Bacharel', 'Bacharelado', NULL,
 NULL,
 '{"tipo":"Portaria","numero":"268","data":"2017-04-03"}',
 NULL,
 1, NOW()),
-- PORTARIA DUPLA
(22, 3, 'Administração', 1261187, 'Presencial', 'Bacharel', 'Bacharelado', '3000',
 '{"tipo":"Portaria","numero":"254","data":"2015-03-17"}',
 '{"tipo":"Portaria","numero":"254","data":"2015-03-17"}',
 NULL,
 1, NOW()),
(23, 3, 'Pedagogia', 105812, 'Presencial', 'Licenciado', 'Licenciatura', '3300',
 '{"tipo":"Portaria","numero":"3530","data":"2004-10-29"}',
 '{"tipo":"Portaria","numero":"916","data":"2018-12-27"}',
 NULL,
 1, NOW()),
-- PORTARIA DUPLA
(24, 3, 'Teologia', 1180229, 'Presencial', 'Bacharel', 'Bacharelado', '3000',
 '{"tipo":"Portaria","numero":"326","data":"2013-07-24"}',
 '{"tipo":"Portaria","numero":"326","data":"2013-07-24"}',
 NULL,
 1, NOW())
