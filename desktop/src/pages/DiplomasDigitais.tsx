  ...
  return (
    <Modal title="Anular Diploma Digital" onClose={onClose} width={560}>
      <div className="alert alert-error" style={{ marginBottom: 12 }}>
        A anula��o � permanente no fluxo, mas <strong>nunca apaga</strong> o processo: documento, motivo, data, usu�rio e
        auditoria ficam preservados (exig�ncia oficial). Confirme com a senha master.
      </div>
      <div className="form-row" style={{ flexDirection: 'column', gap: 10 }}>
        <div style={{ width: '100%' }}>
          <label style={labelStyle}>Motivo (m�n. 10 caracteres � registrado na auditoria) *</label>
