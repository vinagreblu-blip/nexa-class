...
export const IPC_CHANNELS = {
  ...
  ASSINATURA_DIPLOMA_CERTS_OBTER: 'assinatura:diploma-certs-obter',
  ASSINATURA_DIPLOMA_UPLOAD_CERT: 'assinatura:diploma-upload-cert',
  ASSINATURA_DIPLOMA_SALVAR_CERT_A3: 'assinatura:diploma-salvar-cert-a3',
  ...
  ASSINATURA_TSA_OBTER: 'assinatura:tsa-obter',
  ASSINATURA_TSA_SALVAR: 'assinatura:tsa-salvar',
  ASSINATURA_TSA_TESTAR: 'assinatura:tsa-testar',
  ASSINATURA_POLITICA_OBTER: 'assinatura:politica-obter',
  ASSINATURA_POLITICA_SALVAR: 'assinatura:politica-salvar',
  ASSINATURA_POLITICA_CONFIRMAR: 'assinatura:politica-confirmar',
  ...
  DIPLOMAS_DIGITAIS_PUBLICAR: 'diplomas-digitais:publicar',
  DIPLOMAS_DIGITAIS_ANULAR: 'diplomas-digitais:anular',
  DIPLOMAS_DIGITAIS_GERAR_LISTA_ANULADOS: 'diplomas-digitais:gerar-lista-anulados',
  ...
  DIPLOMAS_DIGITAIS_VALIDAR_ARTEFATO: 'diplomas-digitais:validar-artefato',
